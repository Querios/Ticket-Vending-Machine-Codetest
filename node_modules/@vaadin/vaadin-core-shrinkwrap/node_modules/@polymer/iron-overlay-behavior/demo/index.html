...
<demo-snippet>
    <template>
        ...
        <simple-overlay id="toast" allow-click-through no-cancel-on-outside-click horizontal-align="left"
                        vertical-align="bottom" no-auto-focus>
...
<demo-snippet>
    <template>
      <span>
        ...
        <simple-overlay id="lockOnScroll" scroll-action="lock" no-overlap vertical-align="bottom"
                        horizontal-align="left" tabindex="-1">
        ...
        <simple-overlay id="refitOnScroll" scroll-action="refit" no-overlap vertical-align="bottom"
                        horizontal-align="left" tabindex="-1">
        ...
        <simple-overlay id="cancelOnScroll" scroll-action="cancel" no-overlap vertical-align="bottom"
                        horizontal-align="left" tabindex="-1">
